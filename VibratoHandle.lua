...
function VibratoHandle.new()
    ...
    this.startRate = 64;
    this.startDepth = 64;
    this.rateBP = VibratoBPList.new();
    this.depthBP = VibratoBPList.new();
    ...
    ---
    -- コピーを作成する
    -- @return (VibratoHandle) このオブジェクトのコピー
    function this:clone()
        local result = VibratoHandle.new();
    ...
    function this:castToHandle()
        ...
        ret._type = HandleTypeEnum.Vibrato;
