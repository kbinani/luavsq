...
function NoteHeadHandle.new( ids, iconId, index )
    local this = IconParameter.new();

    this.articulation = ArticulationTypeEnum.NoteAttack;
    this.index = 0;
    this.iconId = "";
    this.ids = "";
    this.original = 0;
    ...
    ---
    -- コピーを作成する
    -- @return (NoteHeadHandle) このオブジェクトのコピー
    function this:clone()
        local result = NoteHeadHandle.new();
    ...
    function this:castToHandle()
        ...
        ret._type = HandleTypeEnum.NoteHead;
