...
-- @param defaultValue (int) コントロールカーブのデフォルト値
-- @param minimum (int) コントロールカーブの最小値
-- @param maximum (int) コントロールカーブの最大値
-- @return (BPList)
-- @name new
-- @access static ctor
-- @class function
...
function BPList.new( ... )
    ...
    -- @param value (int) コントロールカーブのデフォルト値
