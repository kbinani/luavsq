...
function Id.new( ... )
    ...
    --[[
        ...
        function this:_init_3( sr, value, last_line )
            ...
            while( last_line.value:find( "[" ) ~= 0 )do
                ...
                if( search == "Type" )then
                    if( spl[2] == "Anote" )then
                        self.type = IdTypeEnum.Anote;
                    elseif( spl[2] == "Singer" )then
                        self.type = IdTypeEnum.Singer;
                    elseif( spl[2] == "Aicon" )then
                        self.type = IdTypeEnum.Aicon;
                    else
                        self.type = IdTypeEnum.Unknown;
                    end
    ...
    ---
    -- コピーを作成する
    -- @return (Id) このインスタンスのコピー
    function this:clone()
        local result = Id.new( self.value );
    ...
    --[[
        ...
        function this:toString()
            ...
            if( self.type == IdTypeEnum.Anote )then
            ...
            elseif( self.type == IdTypeEnum.Singer )then
...
---
-- ミリ秒で表した、音符の最大長さ
Id.MAX_NOTE_MILLISEC_LENGTH = 16383;
