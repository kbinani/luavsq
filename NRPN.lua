...
if( nil == luavsq.NRPN )then
    ...
    luavsq.NRPN.CVM_EXNM_ENV_DATA1 = 0x507e;
    ---
    -- (0x507d) Extended Note message; Envelope: value2(MSB, LSB)
    luavsq.NRPN.CVM_EXNM_ENV_DATA2 = 0x507d;
    ---
    -- (0x507c) Extended Note message; Envelope: value3(MSB)
    luavsq.NRPN.CVM_EXNM_ENV_DATA3 = 0x507c;
    ---
    -- (0x507b) Extended Note message; Envelope: data point continuation(MSB)(MSB, 0x7f=end, 0x00=continue)
    luavsq.NRPN.CVM_EXNM_ENV_DATA_CONTINUATION = 0x507b;

    ---
    -- (0x6000) Version number &amp;, Device number(MSB, LSB)
    luavsq.NRPN.CC_BS_VERSION_AND_DEVICE = 0x6000;
    ---
    -- (0x6001) Delay in millisec(MSB, LSB)
    luavsq.NRPN.CC_BS_DELAY = 0x6001;
    ---
    -- (0x6002) Laugnage type(MSB, optional LSB)
    luavsq.NRPN.CC_BS_LANGUAGE_TYPE = 0x6002;

    ---
    -- (0x6100) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.CC_CV_VERSION_AND_DEVICE = 0x6100;
    ---
    -- (0x6101) Delay in millisec(MSB, LSB)
    luavsq.NRPN.CC_CV_DELAY = 0x6101;
    ---
    -- (0x6102) Volume value(MSB)
    luavsq.NRPN.CC_CV_VOLUME = 0x6102;

    ---
    -- (0x6200) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.CC_P_VERSION_AND_DEVICE = 0x6200;
    ---
    -- (0x6201) Delay in millisec(MSB, LSB)
    luavsq.NRPN.CC_P_DELAY = 0x6201;
    ---
    -- (0x6202) Pan value(MSB)
    luavsq.NRPN.CC_PAN = 0x6202;

    ---
    -- (0x6300) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.CC_E_VESION_AND_DEVICE = 0x6300;
    ---
    -- (0x6301) Delay in millisec(MSB, LSB)
    luavsq.NRPN.CC_E_DELAY = 0x6301;
    ---
    -- (0x6302) Expression vlaue(MSB)
    luavsq.NRPN.CC_E_EXPRESSION = 0x6302;

    ---
    -- (0x6400) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.CC_VR_VERSION_AND_DEVICE = 0x6400;
    ---
    -- (0x6401) Delay in millisec(MSB, LSB)
    luavsq.NRPN.CC_VR_DELAY = 0x6401;
    ---
    -- (0x6402) Vibrato Rate value(MSB)
    luavsq.NRPN.CC_VR_VIBRATO_RATE = 0x6402;

    ---
    -- (0x6500) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.CC_VD_VERSION_AND_DEVICE = 0x6500;
    ---
    -- (0x6501) Delay in millisec(MSB, LSB)
    luavsq.NRPN.CC_VD_DELAY = 0x6501;
    ---
    -- (0x6502) Vibrato Depth value(MSB)
    luavsq.NRPN.CC_VD_VIBRATO_DEPTH = 0x6502;

    ---
    -- (0x6600) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.CC_FX2_VERSION_AND_DEVICE = 0x6600;
    ---
    -- (0x6601) Delay in millisec(MSB, LSB)
    luavsq.NRPN.CC_FX2_DELAY = 0x6601;
    ---
    -- (0x6602) Effect2 Depth(MSB)
    luavsq.NRPN.CC_FX2_EFFECT2_DEPTH = 0x6602;

    ---
    -- (0x6700) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.CC_PBS_VERSION_AND_DEVICE = 0x6700;
    ---
    -- (0x6701) Delay in millisec(MSB, LSB)
    luavsq.NRPN.CC_PBS_DELAY = 0x6701;
    ---
    -- (0x6702) Pitch Bend Sensitivity(MSB, LSB)
    luavsq.NRPN.CC_PBS_PITCH_BEND_SENSITIVITY = 0x6702;

    ---
    -- (0x5300) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.PC_VERSION_AND_DEVICE = 0x5300;
    ---
    -- (0x5301) Delay in millisec(MSB, LSB)
    luavsq.NRPN.PC_DELAY = 0x5301;
    ---
    -- (0x5302) Voice Type(MSB)
    luavsq.NRPN.PC_VOICE_TYPE = 0x5302;

    ---
    -- (0x5400) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.PB_VERSION_AND_DEVICE = 0x5400;
    ---
    -- (0x5401) Delay in millisec(MSB, LSB)
    luavsq.NRPN.PB_DELAY = 0x5401;
    ---
    -- (0x5402) Pitch Bend value(MSB, LSB)
    luavsq.NRPN.PB_PITCH_BEND = 0x5402;

    ---
    -- (0x5500) Version number &amp;, device number(MSB, LSB)
    luavsq.NRPN.VCP_VERSION_AND_DEVICE = 0x5500;
    ---
    -- (0x5501) Delay in millisec(MSB, LSB)
    luavsq.NRPN.VCP_DELAY = 0x5501;
    ---
    -- (0x5502) Voice Change Parameter ID(MSB)
    luavsq.NRPN.VCP_VOICE_CHANGE_PARAMETER_ID = 0x5502;
    ---
    -- (0x5503) Voice Change Parameter value(MSB)
    luavsq.NRPN.VCP_VOICE_CHANGE_PARAMETER = 0x5503;
    ...
    -- @param nrpn [int]
    -- @return [bool]
    function luavsq.NRPN.isDataLsbRequire( nrpn )
        if( nrpn == luavsq.NRPN.CVM_NM_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.CVM_NM_DELAY or
            nrpn == luavsq.NRPN.CVM_NM_NOTE_DURATION or
            nrpn == luavsq.NRPN.CVM_NM_INDEX_OF_VIBRATO_DB or
            nrpn == luavsq.NRPN.CVM_NM_VIBRATO_CONFIG or
            nrpn == luavsq.NRPN.CVM_NM_PHONETIC_SYMBOL1 or
            nrpn == luavsq.NRPN.CC_BS_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.CC_BS_DELAY or
            nrpn == luavsq.NRPN.CC_BS_LANGUAGE_TYPE or
            nrpn == luavsq.NRPN.CC_CV_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.CC_CV_DELAY or
            nrpn == luavsq.NRPN.CC_P_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.CC_P_DELAY or
            nrpn == luavsq.NRPN.CC_E_VESION_AND_DEVICE or
            nrpn == luavsq.NRPN.CC_E_DELAY or
            nrpn == luavsq.NRPN.CC_VR_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.CC_VR_DELAY or
            nrpn == luavsq.NRPN.CC_VD_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.CC_VD_DELAY or
            nrpn == luavsq.NRPN.CC_FX2_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.CC_FX2_DELAY or
            nrpn == luavsq.NRPN.CC_PBS_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.CC_PBS_DELAY or
            nrpn == luavsq.NRPN.CC_PBS_PITCH_BEND_SENSITIVITY or
            nrpn == luavsq.NRPN.PC_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.PC_DELAY or
            nrpn == luavsq.NRPN.PB_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.PB_DELAY or
            nrpn == luavsq.NRPN.PB_PITCH_BEND or
            nrpn == luavsq.NRPN.VCP_VERSION_AND_DEVICE or
            nrpn == luavsq.NRPN.VCP_DELAY or
            nrpn == luavsq.NRPN.CVM_EXNM_ENV_DATA1 or
            nrpn == luavsq.NRPN.CVM_EXNM_ENV_DATA2 )then
            return true;
        elseif( nrpn == luavsq.NRPN.CVM_NM_NOTE_NUMBER or
            nrpn == luavsq.NRPN.CVM_NM_VELOCITY or
            nrpn == luavsq.NRPN.CVM_NM_NOTE_LOCATION or
            nrpn == luavsq.NRPN.CVM_NM_VIBRATO_DELAY or
        --case luavsq.NRPN.CVM_NM_UNKNOWN1 or
            nrpn == luavsq.NRPN.CVM_NM_PHONETIC_SYMBOL_BYTES or
            nrpn == luavsq.NRPN.CVM_NM_PHONETIC_SYMBOL_CONTINUATION or
            nrpn == luavsq.NRPN.CVM_NM_V1MEAN or
            nrpn == luavsq.NRPN.CVM_NM_D1MEAN or
            nrpn == luavsq.NRPN.CVM_NM_D1MEAN_FIRST_NOTE or
            nrpn == luavsq.NRPN.CVM_NM_D2MEAN or
            nrpn == luavsq.NRPN.CVM_NM_D4MEAN or
            nrpn == luavsq.NRPN.CVM_NM_PMEAN_ONSET_FIRST_NOTE or
            nrpn == luavsq.NRPN.CVM_NM_VMEAN_NOTE_TRNSITION or
            nrpn == luavsq.NRPN.CVM_NM_PMEAN_ENDING_NOTE or
            nrpn == luavsq.NRPN.CVM_NM_ADD_PORTAMENTO or
            nrpn == luavsq.NRPN.CVM_NM_CHANGE_AFTER_PEAK or
            nrpn == luavsq.NRPN.CVM_NM_ACCENT or
            nrpn == luavsq.NRPN.CVM_NM_NOTE_MESSAGE_CONTINUATION or
            nrpn == luavsq.NRPN.CC_CV_VOLUME or
            nrpn == luavsq.NRPN.CC_PAN or
            nrpn == luavsq.NRPN.CC_E_EXPRESSION or
            nrpn == luavsq.NRPN.CC_VR_VIBRATO_RATE or
            nrpn == luavsq.NRPN.CC_VD_VIBRATO_DEPTH or
            nrpn == luavsq.NRPN.CC_FX2_EFFECT2_DEPTH or
            nrpn == luavsq.NRPN.PC_VOICE_TYPE or
            nrpn == luavsq.NRPN.VCP_VOICE_CHANGE_PARAMETER_ID or
            nrpn == luavsq.NRPN.VCP_VOICE_CHANGE_PARAMETER or
            nrpn == luavsq.NRPN.CVM_EXNM_ENV_DATA3 or
            nrpn == luavsq.NRPN.CVM_EXNM_ENV_DATA_CONTINUATION )then
            return false;
        end
        return false;
    end
